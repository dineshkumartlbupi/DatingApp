    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={handleBackPress} style={styles.headerButton}>
          <Ionicons name="chevron-back" size={24} color={Colors.light.redText} />
        </TouchableOpacity>
        
        <TouchableOpacity onPress={handleEditPress} style={styles.headerButton}>
          <Ionicons name="create-outline" size={24} color={Colors.light.redText} />
        </TouchableOpacity>
      </View>
      ...
      >
        <Image source={{ uri: profileData.mainImage }} style={styles.mainImage} />
      </Animated.View>
      ...
      >
        ...
        <TouchableOpacity style={styles.actionButton} onPress={handleSuperLikePress}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.profileInfo}>
            <View style={styles.nameContainer}>
              <RnText style={styles.name}>{profileData.name}, {profileData.age}</RnText>
                <RnText style={styles.profession}>{profileData.profession}</RnText>
            </View>
            <TouchableOpacity style={styles.sendButton} onPress={handleSendPress}>
                {/* <Ionicons name="send" size={20} color={Colors.light.redText} /> */}
                <RoundButton iconName='send' iconSize={26} iconColor={Colors.light.redText} borderColor={Colors.light.redText}/>
              </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            <RnText style={styles.about} numberOfLines={showFullAbout ? undefined : 3}>
              {profileData.about}
            </RnText>
            ...
            <View style={styles.gallery}>
              <View style={styles.galleryRow}>
                <TouchableOpacity style={styles.largeGalleryItem}>
                  <Image source={{ uri: profileData.gallery[0] }} style={styles.galleryImage} />
                  <View style={styles.playButton}>
                    <Ionicons name="play" size={20} color={Colors.light.whiteText} />
                  </View>
                </TouchableOpacity>
              </View>
